...
data_event[dvTV]
{
    online:
    {
		sendCommand (dvTV, "'CTON',3")
		sendCommand (dvTV, "'CTOF',5")
		sendCommand (dvTV, "'XCHM-0'")
    }
}
...
BUTTON_EVENT[dvTpTableTv,0]
{
    PUSH:
    {
		...
		switch(button.input.channel)
		{
			case BTN_TV_PRESET_SELECT_ABC_1:      sendCommand (dvTV, "'CH',2")
			case BTN_TV_PRESET_SELECT_ABC_2:      sendCommand (dvTV, "'CH',22")
			case BTN_TV_PRESET_SELECT_ABC_3:      sendCommand (dvTV, "'CH',23")
			case BTN_TV_PRESET_SELECT_SEVEN:      sendCommand (dvTV, "'CH',7")
			case BTN_TV_PRESET_SELECT_SEVEN_2:    sendCommand (dvTV, "'CH',72")
			case BTN_TV_PRESET_SELECT_SEVEN_MATE: sendCommand (dvTV, "'CH',73")
			case BTN_TV_PRESET_SELECT_NINE:       sendCommand (dvTV, "'CH',9")
			case BTN_TV_PRESET_SELECT_GO:         sendCommand (dvTV, "'CH',99")
			case BTN_TV_PRESET_SELECT_GEM:        sendCommand (dvTV, "'CH',90")
			case BTN_TV_PRESET_SELECT_ONE:        sendCommand (dvTV, "'CH',1")
			case BTN_TV_PRESET_SELECT_TEN:        sendCommand (dvTV, "'CH',10")
			case BTN_TV_PRESET_SELECT_ELEVEN:     sendCommand (dvTV, "'CH',11")
			case BTN_TV_PRESET_SELECT_SBS_1:      sendCommand (dvTV, "'CH',3")
			case BTN_TV_PRESET_SELECT_SBS_2:      sendCommand (dvTV, "'CH',32")
			case BTN_TV_PRESET_SELECT_CHANNEL_31: sendCommand (dvTV, "'CH',31")
			case BTN_TV_PRESET_SELECT_ABC_NEWS:   sendCommand (dvTV, "'CH',24")
			case BTN_TV_PRESET_SELECT_4ME:        sendCommand (dvTV, "'CH',74")
			case BTN_TV_PRESET_SELECT_EXTRA:      sendCommand (dvTV, "'CH',94")
			
			// All other Tv control buttons (keypad/menu) have their channel codes mapped to the corresponding IR function in the IR file
			default:                              sendCommand (dvTV, "'SP',button.input.channel")
		}
    }
}
