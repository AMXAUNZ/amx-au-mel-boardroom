...
RmsSourceUsageAssignAsset(dvDvxVidInTv.port, vdvTv)
...
initArea (dragAreasTpTable[dvDvxVidInTv.port],      528,  376, 134, 105)
initArea (dragAreasTpTable[dvDvxVidInEnzo.port],    674,  376, 134, 105)
initArea (dragAreasTpTable[dvDvxVidInPc.port],      820,  376 ,134, 105)
initArea (dragAreasTpTable[dvDvxVidInSignage.port], 966,  376, 134, 105)
initArea (dragAreasTpTable[dvDvxVidInTx1.port],     1112, 376 ,134, 105)
initArea (dragAreasTpTable[dvDvxVidInTx2.port],     1258, 376, 134, 105)
